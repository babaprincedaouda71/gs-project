...
public interface TrainingRest {
    ...
    @GetMapping("/trainingGroup/find/groupsByIds")
    @CircuitBreaker(name = "trainingService", fallbackMethod = "getAllDefaultGroups")
    List<Group> findGroupsByIds(List<Long> groupIds);
    ...
    default List<Group> getAllDefaultGroups(Exception exception){
        return List.of();
    }
