...
export class EditVendorComponent implements OnInit, OnDestroy {
  ...
  buildEditForm() {
    this.editVendorForm = this.fb.group({
      idSupplier: [this.vendor.idSupplier],
      status: [this.vendor.status, []],
      phone: [this.vendor.phone, []],
      email: [this.vendor.email, []],
      address: [this.vendor.address, []],
      nameMainContact: [this.vendor.nameMainContact, [Validators.required]],
      phoneNumberMainContact: [this.vendor.phoneNumberMainContact, [Validators.required]],
      emailMainContact: [this.vendor.emailMainContact, [Validators.required, Validators.email]],
      positionMainContact: [this.vendor.positionMainContact, [Validators.required]],
