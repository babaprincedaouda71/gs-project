...
export class TrainingComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  statusMapping: { [key: string]: { label: string; class: string } } = {
    Recherche_formateur: { label: "Recherche Formateur", class: "bg-light-primary" },
    Validation_formateur: { label: "Validation Formateur", class: "bg-light-accent" },
    Reunion_de_cadrage: { label: "Réunion de Cadrage", class: "bg-light-error" },
    Support_de_formation: { label: "Support de Formation", class: "bg-light-success" },
    Impression: { label: "Impression", class: "bg-light-warning" },
    Realisation: { label: "Réalisation", class: "bg-light" },
    Attestation: { label: "Livrable Formation", class: "bg-light" },
    Facturation: { label: "Facturation", class: "bg-light" },
    Reglement: { label: "Payement", class: "bg-light" },
    Attestation_de_référence: { label: "Attestation de Référence", class: "bg-light" },
    Realisée: { label: "Réalisée", class: "bg-light" }
  };
  ...
  * */
  ...
  checkVendor(event: any) {
    this.local_data.groups.forEach((group: GroupModel) => {
      if (!group.supplier || group.supplier.idSupplier == null) {
